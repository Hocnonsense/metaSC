...
class BamFile:
    ...
    def get_contigs(self) -> None: ...
    def get_contigs_obj(self) -> None: ...
    def get_contig_by_label(self, contigID) -> None: ...
...
class BamContig:
    ...
    def majority_rule(data_array) -> None: ...
    def majority_rule_polymorphicLoci(data_array) -> None: ...
    ...
    def easy_polymorphism_rate(self, mincov=..., minqual=..., dominant_frq_thrsh=...) -> None: ...
    def polymorphism_rate(self, mincov=..., minqual=..., pvalue=..., error_rate=..., dominant_frq_thrsh=...) -> None: ...
    ...
    def get_all_base_values(self, stats_value, *f_args, **f_kwargs) -> None: ...

def loc_gte(a, b) -> None: ...
def loc_lte(a, b) -> None: ...
def loc_gt(a, b) -> None: ...
def loc_lt(a, b) -> None: ...
def loc_leq(a, b) -> None: ...
