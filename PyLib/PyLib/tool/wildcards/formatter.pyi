import string
from .common import Pattern as Pattern
...
class SequenceFormatter(string.Formatter):
    ...
    def format_element(self, elem, format_spec) -> None: ...
    def format_field(self, value, format_spec) -> None: ...
...
class GetKeyFormatter(string.Formatter):
    ...
    def get_value(self, key, args, kwargs) -> None: ...
    @classmethod
